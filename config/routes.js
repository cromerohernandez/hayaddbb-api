...
router.post('/houses/new', cacheMiddleware.delAllKeysBasicsCache, housesController.create)
...
router.delete('/houses/:id', cacheMiddleware.delAllKeysBasicsCache, housesController.delete)
